...
public class PubmedEFetchHandler extends DefaultHandler {
  ...
  /**
   * Pull out year. Year is the first four consecutive numbers in the string. Attempt to pull out
   * month. (This won't always work.) Month is the first three consecutive letters. Map these
   * letters to a two-digit month equivalent, e.g., "Feb" --> "02", "Oct" --> "10" Use "01" for day.
   * Don't bother trying to parse that. PMID(23849565) OR PMID(29756752)
   *
  ...
  /**
   * Get the IdType value of ArticleId tag. Example:
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes)
    ...
    if (pubmedArticle != null) {
      if (qName.equalsIgnoreCase("MedlineCitation")) {
        pubmedArticle.setMedlinecitation(
            MedlineCitation.builder().build()); // set the PubmedArticle's MedlineCitation.
      ...
      if (qName.equalsIgnoreCase("Article")) {
        pubmedArticle.getMedlinecitation().setArticle(MedlineCitationArticle.builder()
            .build()); // set the PubmedArticle's MedlineCitation's MedlineCitationArticle.
        bArticle = true;
      }
      ...
      if (qName.equalsIgnoreCase("ELocationID") && attributes.getValue("EIdType")
          .equalsIgnoreCase("doi")) {
        pubmedArticle.getMedlinecitation().getArticle()
            .setElocationid(MedlineCitationArticleELocationID.builder().build());
        bELocationID = true;
      }

      if (qName.equalsIgnoreCase("Journal")) {
        pubmedArticle.getMedlinecitation().getArticle()
            .setJournal(MedlineCitationJournal.builder().build()); // add journal information.
      }

      if (qName.equalsIgnoreCase("ISSN")) {
        pubmedArticle.getMedlinecitation().getArticle().getJournal()
            .setIssn(new ArrayList<MedlineCitationJournalISSN>());
        MedlineCitationJournalISSN journalIssn = MedlineCitationJournalISSN.builder()
            .issntype(getIssnType(attributes)).build();
      ...
      if (qName.equalsIgnoreCase("ISSNLinking")) {
        ...
        MedlineCitationJournalISSN journalLIssn = MedlineCitationJournalISSN.builder()
            .issntype("Linking").build();
      ...
      if (qName.equalsIgnoreCase("JournalIssue")) {
        pubmedArticle.getMedlinecitation().getArticle().getJournal()
            .setJournalissue(MedlineCitationJournalIssue.builder().build());
      }
      ...
      if (qName.equalsIgnoreCase("PubDate")) {
        pubmedArticle.getMedlinecitation().getArticle().getJournal().getJournalissue()
            .setPubdate(MedlineCitationDate.builder().build());
        bPubDate = true;
      }
      ...
      if (qName.equalsIgnoreCase("AuthorList") &&
          pubmedArticle != null) {
        pubmedArticle.getMedlinecitation().getArticle().setAuthorlist(
            new ArrayList<>()); // set the PubmedArticle's MedlineCitation's MedlineCitationArticle's title.
        bAuthorList = true;
      }
      if (qName.equalsIgnoreCase("Author")) {
        MedlineCitationArticleAuthor author = MedlineCitationArticleAuthor.builder().build();
        pubmedArticle.getMedlinecitation().getArticle().getAuthorlist()
            .add(author); // add author to author list.
        bAuthor = true;
      }
      ...
      if (qName.equalsIgnoreCase("Abstract") &&
          pubmedArticle != null) {
        pubmedArticle.getMedlinecitation().getArticle().setPublicationAbstract(
            MedlineCitationArticleAbstract.builder().abstractTexts(new ArrayList<>()).build());
        bAbstract = true;
      }
      if (qName.equalsIgnoreCase("AbstractText") && bAbstract) {
        MedlineCitationArticleAbstractText abstractText = MedlineCitationArticleAbstractText
            .builder().abstractTextLabel(getAbstractTextLabel(attributes))
            .abstractTextNlmCategory(getAbstractTextNlmCategory(attributes)).build();
        pubmedArticle.getMedlinecitation().getArticle().getPublicationAbstract().getAbstractTexts()
            .add(abstractText);
        bAbstractText = true;
      }
      ...
      if (qName.equalsIgnoreCase("PublicationTypeList") &&
          pubmedArticle != null) {
        pubmedArticle.getMedlinecitation().getArticle().setPublicationtypelist(
            new ArrayList<>()); // set the PubmedArticle's MedlineCitation's MedlineCitationArticle's title.
      ...
      if (qName.equalsIgnoreCase("DescriptorName")) {
        ...
        MedlineCitationMeshHeading medlineCitationMeshHeading = MedlineCitationMeshHeading.builder()
            .build();
      ...
      if (qName.equalsIgnoreCase("QualifierName")) {
        ...
        List<MedlineCitationMeshHeadingQualifierName> medlineCitationMeshHeadingQualifierNames =
            pubmedArticle.getMedlinecitation().getMeshheadinglist().get(size - 1)
                .getQualifiernamelist();
      ...
      if (qName.equalsIgnoreCase("CommentsCorrectionsList")) {
        ...
        pubmedArticle.getMedlinecitation()
            .setCommentscorrectionslist(medlineCitationCommentsCorrections);
      ...
      if (qName.equalsIgnoreCase("ArticleDate")) {
        bArticleDate = true;
        pubmedArticle.getMedlinecitation().getArticle()
            .setArticledate(MedlineCitationDate.builder().build());
      }
      ...
      if (qName.equalsIgnoreCase("ArticleId") && bReferenceArticleIdList) {
        if (getReferenceArticleIdType(attributes).equalsIgnoreCase("pubmed")) {
          ...
          MedlineCitationCommentsCorrections medlineCitationCommentsCorrections = MedlineCitationCommentsCorrections
              .builder().build();
          pubmedArticle.getMedlinecitation().getCommentscorrectionslist()
              .add(medlineCitationCommentsCorrections);
        }
      }
      ...
      if (qName.equalsIgnoreCase("PubMedPubDate")) {
        ...
        PubMedPubDate pubmedPubDate = PubMedPubDate.builder().pubMedPubDate(medlineCitationDate)
            .pubStatus(getPubStatus(attributes)).build();
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    ...
    if (pubmedArticle != null) {
      ...
      if (bMedlineCitation && bPMID) {
        ...
        pubmedArticle.getMedlinecitation()
            .setMedlinecitationpmid(MedlineCitationPMID.builder().pmid(pmid).build());
        bPMID = false;
      ...
      if (bArticle && bArticleTitle) {
        String articleTitle = chars.toString().replaceAll("\\R+\\s{2,}", " ")
            .trim(); //replace new line breaks and any two or more whitespaces with single whitespace
        pubmedArticle.getMedlinecitation().getArticle()
            .setArticletitle(articleTitle); // set the title of the Article.
        bArticleTitle = false;
      }

      if (bELocationID) {
        String eLocationId = chars.toString().trim();
        if (!eLocationId.contains(
            " ")) { //Case where doi would have a space in between doi which causes exception when retrieving scopus articles using doi - pmid - 24763504
          pubmedArticle.getMedlinecitation().getArticle().getElocationid()
              .setElocationid(eLocationId);
        }
        bELocationID = false;
      }
      ...
      if (bAuthorLastName) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getArticle().getAuthorlist().size() - 1;
        pubmedArticle.getMedlinecitation().getArticle().getAuthorlist().get(lastInsertedIndex)
      ...
      if (bISSN) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getArticle().getJournal().getIssn().size() - 1;
        pubmedArticle.getMedlinecitation().getArticle().getJournal().getIssn()
            .get(lastInsertedIndex).setIssn(issn);
        bISSN = false;
      }
      ...
      if (bISSNLinking) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getArticle().getJournal().getIssn().size() - 1;
        pubmedArticle.getMedlinecitation().getArticle().getJournal().getIssn()
            .get(lastInsertedIndex).setIssn(lissn);
        bISSNLinking = false;
      }
      ...
      if (bPubDate && bPubDateYear) {
        ...
        pubmedArticle.getMedlinecitation().getArticle().getJournal().getJournalissue().getPubdate()
            .setYear(pubDateYear);
        //bPubDate = false;
        bPubDateYear = false;
      }
      ...
      if (bPubDate && bMedlineDate) {
        ...
        pubmedArticle.getMedlinecitation().getArticle().getJournal().getJournalissue()
            .setMedlineDate(medlineDate);
        MedlineCitationDate medlineCitationDate = pubmedArticle.getMedlinecitation().getArticle()
            .getJournal().getJournalissue().getPubdate();
      ...
      if (bPagination && bMedlinePgn) {
        ...
        if (pagination != null
            &&
            !pagination.isEmpty()) {
          pubmedArticle.getMedlinecitation().getArticle().getPagination().getMedlinepgns()
              .add(pagination);
        }
        bMedlinePgn = false;
      }
      ...
      if (bPublicationTypeList && bPublicationType) {
        MedlineCitationPublicationType publicationType = MedlineCitationPublicationType.builder()
            .build();
        publicationType.setPublicationtype(chars.toString());
        pubmedArticle.getMedlinecitation().getArticle().getPublicationtypelist()
            .add(publicationType);
      ...
      if (bAbstractText && bAbstract) {
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getArticle().getPublicationAbstract()
                .getAbstractTexts().size() - 1;
        String publicationAbstractText = chars.toString();
        pubmedArticle.getMedlinecitation().getArticle().getPublicationAbstract().getAbstractTexts()
            .get(lastInsertedIndex).setAbstractText(publicationAbstractText);
        bAbstractText = false;
      }

      if (bCopyrightInformation && bAbstract) {
        MedlineCitationArticleAbstract publicationAbstract = pubmedArticle.getMedlinecitation()
            .getArticle().getPublicationAbstract();
      ...
      if (bDescriptorName) {
        ...
        pubmedArticle.getMedlinecitation().getMeshheadinglist().get(lastInsertedIndex)
            .getDescriptorname().setDescriptorname(descriptorName); // set descriptor name for MeSH.
      ...
      if (bQualifierName) {
        ...
        int lastInsertedMeshHeadingIndex =
            pubmedArticle.getMedlinecitation().getMeshheadinglist().size() - 1;
        MedlineCitationMeshHeading meshHeading = pubmedArticle.getMedlinecitation()
            .getMeshheadinglist().get(lastInsertedMeshHeadingIndex);
      ...
      if (bGrant && bGrantId) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getArticle().getGrantlist().size() - 1;
        pubmedArticle.getMedlinecitation().getArticle().getGrantlist().get(lastInsertedIndex)
            .setGrantid(grantId);
        bGrantId = false;
      }
      ...
      if (bReferenceArticleId && bReferenceArticleIdList) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getMedlinecitation().getCommentscorrectionslist().size() - 1;
        pubmedArticle.getMedlinecitation().getCommentscorrectionslist().get(lastInsertedIndex)
            .setPmid(articleId);
      ...
      if (bPubMedPubDate && bPubMedPubDateYear) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().size() - 1;
        pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().get(lastInsertedIndex)
            .getPubMedPubDate().setYear(pubmedPubDateYear);
      ...
      if (bPubMedPubDate && bPubMedPubDateMonth) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().size() - 1;
        pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().get(lastInsertedIndex)
            .getPubMedPubDate().setMonth(pubmedPubDateMonth);
      ...
      if (bPubMedPubDate && bPubMedPubDateDay) {
        ...
        int lastInsertedIndex =
            pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().size() - 1;
        pubmedArticle.getPubmeddata().getHistory().getPubmedPubDate().get(lastInsertedIndex)
            .getPubMedPubDate().setDay(pubmedPubDateDay);
